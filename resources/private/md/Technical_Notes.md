...
**Written in Clojure**. I know the implementation language isn't too important, but I like Clojure. No Javascript. Even though it is very popular right now, it is ugly. I don't like it at all.
...
**Mathematics**. I want to be able to write content containing mathematics. Markdown does not support it natively. I wanted to be able to use [$\rm\LaTeX$](https://en.wikibooks.org/wiki/LaTeX/Mathematics).
...
* Developed and tested with Clojure 1.8.
...
* Mathematics formatting using [$\rm\LaTeX$](https://en.wikibooks.org/wiki/LaTeX/Mathematics) syntax being rendered by [MathJax](https://www.mathjax.org/).

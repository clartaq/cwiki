...
These wiki programs are all open source and under active development, as this is written (Summer 2020). I encourage you to visit the home page of each of these projects and see what you think.

This list is by no means exhaustive. There are literally hundreds of programs that could be listed here. These are just some that I have used or found interesting.
...
I originally started using [Joplin](https://joplinapp.org) because it had a reliable function to import [Evernote] notes.
...
- More Javascript, although it seems performant enough.
